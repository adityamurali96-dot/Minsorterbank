...
REM --- Run the main flow as a subroutine so that no matter how it
REM     exits (success, error, or "exit /b"), we ALWAYS land at the
REM     pause below. That way the Command Prompt window never just
REM     vanishes without telling the user what happened.
call :main
